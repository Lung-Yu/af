...
double NEAT::mutation_link = 0.2; //突變添加連結
double NEAT::mutation_node = 0.2; //突變添加節點
double NEAT::mutation_reduce_link = 0.8; //突變減少連結
double NEAT::mutation_reduce_node = 0.8; //突變減少節點

double NEAT::survival_rate = 0.4; //存活比率90% 代表最後10%的基因被淘汰
double NEAT::reproduce_rate = 0.7; //複製率70%代表從現有中複製70%的基因
int NEAT::growth_time = 500;
