...
void DataHelper::ValidMode()
{
    this->input_datas.clear();
    this->desire_datas.clear();

    this->isTrain = true;
    string train_file("dataset/Arrhythmiatest_valid.txt");
...
void DataHelper::TrainingMode()
{
    ...
    this->isTrain = true;
    string train_file("dataset/Arrhythmiatest_train.txt");
    vector<vector<double>> datas = read_file(train_file);
...
void DataHelper::InferenceMode()
{
    ...
    this->isTrain = false;
    string test_file("dataset/Arrhythmiatest_test.txt");
